...
<head>
    ...
    <!-- Title -->
    <title>Gửi Ngàn Lời Yêu | Đăng Nhập</title>

    <meta content="width=device-width, initial-scale=1" name="viewport"/>
    <meta charset="UTF-8">
    <meta name="description" content="admintemplate Dashboard Template" />
    <meta name="keywords" content="admintemplate,dashboard" />
        ...
        <div id="main-wrapper">
            <div class="row">
                <div class="col-md-3 center">
                    <div class="login-box">
                        <a href="" class="logo-name text-lg text-center">Gửi Ngàn Lời Yêu</a>
                        <p class="text-center m-t-md">Vui lòng nhập thông tin đăng nhập vào bên dưới</p>
                        <form class="m-t-md" method="POST" action="admin/login">
                        ...
                        <p class="text-center m-t-xs text-sm">Copyright &copy; 2017 | CloudFone.vn.<br>All Rights Reserved.</p>
                    </div>
                </div>
            </div><!-- Row -->
        </div><!-- Main Wrapper -->
